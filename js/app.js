...
const displayFlowers = (flowers) => {
  flowers.forEach((flower) => {
    ...
    card.innerHTML = `
        <div class="card bg-dark text-white pt-3" style="width:350px;">
          <img src="${flower.image}" class="card-img-top rounded mx-auto d-block" alt="${flower.title}" style="width:280px; height:210px;">
